...
var loadChatWindow = function () {
    ...
    if (clientStore && clientStore != null) {
        var client = JSON.parse(clientStore);
    ...
    function s(e, t) {
        // $.ajax({
        //     type: "GET",
        //     url: "https://api.api.ai/v1/query?v=20160910&query=" + e + "&lang=en-us&sessionId=" + l,
        //     contentType: "application/json",
        //     dataType: "json",
        //     headers: {
        //         Authorization: "Bearer 6e5c2c2195084691937add3ae219e397"
        //     },
        //     success: function(e) {
        //         ! function(e) {
        //             e.result.action;
        //             var t = e.result.fulfillment.speech;
        //             e.result.actionIncomplete;
        //             if (e.result.fulfillment.messages && 0 < e.result.fulfillment.messages.length) var o = e.result.fulfillment.messages[1];
        //             a = t, s = '<p class="botResponse">' + (a = "" == $.trim(a) ? "I couldn't get that. Let' try something else!" : a.replace(new RegExp("\r?\n", "g"), "<br />")) + "</p>", $("#chatbox_body_content").append(s), $("#chatbox_body_content").scrollTop(1e10), o && (n = o, setTimeout(function() {
        //                 var e = n.replies,
        //                     t = n.replies.length,
        //                     o = "";
        //                 for (i = 0; i < t; i++) o += '<span class="sugg-options">' + e[i] + "</span>";
        //                 var a = '<div class="suggestions"><div class="sugg-title">Suggestions:</div>' + o + "</div>";
        //                 $("#chatbox_body_content").append(a), $("#chatbox_body_content").scrollTop(1e10)
        //             }, 1e3));
        //             var n;
        //             var a, s
        //         }(e)
...
debugger;
    ...
    e.on("click", function () {
        ...
        var client = {'clientId':clientId,'name':name,'email':email};
